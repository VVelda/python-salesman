...
class Euc_3D:
    ...
    def __sub__(self, other):
        return Euc_3D(self.x - other.x, self.y - other.y, self.z - other.z)
...
def euc_distance(city1, city2):
    return int(round((city1 - city2).norm()))
...
def matrix_distance(city1, city2):
	return city1.matrix[city1.i][city2.i]
...
def distance(city1, city2):
    ...
    elif type(city1) in [Euc_2D, Euc_3D]:
        return euc_distance(city1, city2)
    elif type(city1) == MatrixCity:
        return matrix_distance(city1, city2)
